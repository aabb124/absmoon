# Dev : https://t.me/tt77t7tt7
#Group : https://t.me/KTTCC
import requests
...
@app.on_message(command(["الر","/li"]) & ~filters.bot & ~filters.private)
